...
body <- dashboardBody(
  tabItems(
    ...
    tabItem(tabName = "overview", 
            ...
            fluidRow(
              valueBox("144 Million", "Subscribers", icon = icon("play-circle"), color = "green"),
              valueBox("320 Million", "Monthly active users", icon = icon("users"), color = "green"),
              valueBox("92", "Markets", icon = icon("globe-asia"), color = "green"),
              valueBox("60 Million+", "Tracks", icon = icon("music"), color = "green"),
              valueBox("1.9 Million+", "Podcasts", icon = icon("podcast"), color = "green"),
